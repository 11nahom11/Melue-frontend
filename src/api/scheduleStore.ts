...
// The Teacher scheduling calendar and the Coordinator Operational
// Management screen both read and write THIS store, so an appointment
// created in one role is immediately visible in the other. Once a real
// backend exists, this module becomes a thin cache on top of the API.
