// components/ExportPreviewModal.tsx
// Reusable frontend-only export: renders the document text in a
// read-only preview and shares it via the native share sheet. No PDF
// library is required; this keeps export fully client-side until a
// backend file-service exists (then SwapShare for the API call).
