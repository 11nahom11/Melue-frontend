// screens/parent/ParentReportsScreen.tsx
// MR-50: Parent Reports & Documents library — reports from the center
// (progress, assessments, attendance, therapy notes, invoices) grouped by
// category with view/download actions.
