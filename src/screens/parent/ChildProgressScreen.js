// screens/parent/ChildProgressScreen.js
// SCR-PAR-002: Child Progress View - parent-friendly, simplified language
...
export default function ChildProgressScreen({ navigation }) {
...
const DEMO_SESSION_SUMMARY = { date: 'Aug 11, 2026', parentFriendlyNote: 'Great session today! Student A asked for toys independently five times and stayed calm during cleanup.' };
