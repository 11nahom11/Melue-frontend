// screens/parent/HomeObservationLogScreen.js
...
export default function HomeObservationLogScreen({ navigation }) {
  ...
  const handleSave = async (payload) => {
    const newEntry = { id: `local-${Date.now()}`, date: 'Just now', ...payload, acknowledged: 'pending', teamResponse: null };
