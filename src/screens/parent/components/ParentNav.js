// screens/parent/components/ParentNav.js
...
const TABS = ['Dashboard', 'Progress', 'Observations', 'Messages'];

export const PARENT_ROUTE_BY_TAB = {
...
export default function ParentNav({ activeTab, onTabPress }) {
