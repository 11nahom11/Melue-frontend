...
const STATUS_KEY = { 'In Progress': 'inProgress', Complete: 'completed', Reviewed: 'approved' };
...
export default function AssessmentReviewScreen({ navigation }) {
  ...
  const handleMarkReviewed = async (studentId, notes) => {
