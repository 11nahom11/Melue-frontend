// screens/programdirector/ProgramDirectorDashboardScreen.js
...
export default function ProgramDirectorDashboardScreen({ navigation }) {
  ...
  const goto = (tab) => navigation?.navigate?.(PD_ROUTE_BY_TAB[tab]);
