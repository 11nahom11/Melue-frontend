// screens/notifications/NotificationsList.tsx
// MR-52: shared in-app notifications list (announcements, goal updates,
// appointment reminders, alerts). Each role's thin wrapper supplies its
// own data loader, demo data and nav chrome.
