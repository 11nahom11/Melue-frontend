// screens/notifications/TeacherNotificationsScreen.tsx
// MR-52: Teacher-side notifications (appointment reminders, goal
// completions, alerts). Reached via the TopNav "Notifications" tab.
