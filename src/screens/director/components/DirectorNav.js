// screens/director/components/DirectorNav.js
...
const TABS = ['Dashboard', 'Scheduling', 'Approvals', 'Parents', 'Reports', 'Progress'];

export const DIRECTOR_ROUTE_BY_TAB = {
...
export default function DirectorNav({ activeTab, onTabPress }) {
