...
const REPORT_TABS = ['Session Reports', 'Bi-Annual Reports', 'Student Progress', 'Foundation Overview'];

export default function ReportsOversightScreen({ navigation }) {
...
const DEMO_OVERVIEW = { totalStudents: 24, totalTeachers: 5, sessionsThisMonth: 96, avgGoalProgress: 61 };
