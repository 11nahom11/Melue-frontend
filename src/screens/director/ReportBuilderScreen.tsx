...
// MR-46: Report Builder & Export — pick filters (program, age range,
// attendance threshold, therapist, date range) and generate a custom
// student report. PDF/Excel export is stubbed (frontend-only).
