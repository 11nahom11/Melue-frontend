...
// SCR-DIR-002: Staff Scheduling - links teachers to students for session
// blocks (distinct from SCR-TC-005's appointment-level scheduling; this
// is block-level teacher/student roster assignment).
...
export default function DirectorSchedulingScreen({ navigation }) {
  ...
  const handleSaveAssignment = async (blockId, studentIds) => {
    try {
