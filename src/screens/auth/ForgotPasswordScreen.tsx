...
//
// MR-4: Forgot / Reset Password flow. Frontend-only demo: the user enters
// a demo email, a "reset code" is shown on screen (123456), and they can
// set a new password. No real backend - the code is just echoed back so
