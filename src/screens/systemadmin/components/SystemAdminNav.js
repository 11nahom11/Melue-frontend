// screens/systemadmin/components/SystemAdminNav.js
...
const TABS = ['Staff Accounts', 'Roles', 'Permissions'];

export const SYS_ROUTE_BY_TAB = {
  'Staff Accounts': 'StaffAccountManagement',
  Roles: 'RoleManagement',
  Permissions: 'PermissionConfiguration',
};

export default function SystemAdminNav({ activeTab, onTabPress }) {
