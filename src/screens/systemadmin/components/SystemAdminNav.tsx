...
export const SYS_ROUTE_BY_TAB: Record<string, keyof SystemAdminStackParamList> = {
  'Admin Panel': 'SystemAdminOverview',
...
export default function SystemAdminNav({ activeTab, onTabPress, sectionTitle }: SystemAdminNavProps) {
    ...
    <View style={s.wrap}>
      <View style={s.left}>
        ...
        <View>
          ...
          <Text style={s.breadcrumb}>{sectionTitle ?? 'System Admin'}</Text>
        </View>
      </View>
      <View style={s.right}>
        ...
        <View style={s.userBlock}>
          ...
          <View>
            ...
            <Text style={s.userRole}>System Admin</Text>
          </View>
        </View>
