...
const TABS = ['Forms', 'Trial Logging', 'ABC Lists', 'Schedule', 'Goal Domains', 'Task Analysis'];

export const IA_ROUTE_BY_TAB = {
  Forms: 'FormBuilder',
...
export default function InstitutionalAdminNav({ activeTab, onTabPress }) {
