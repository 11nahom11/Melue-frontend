// screens/coordinator/LiveSessionMonitoringScreen.js
...
const STATUS_FILTERS = ['All', 'On Track', 'Needs Attention', 'Overdue'];
const STATUS_COLOR = { 'On Track': '#22C55E', 'Needs Attention': '#EAB308', Overdue: '#EF4444' };
...
export default function LiveSessionMonitoringScreen({ navigation }) {
  ...
  const handleSendAlert = async (alertType, message) => {
    try {
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <CoordinatorNav activeTab="Live Sessions" onTabPress={(t) => t !== 'Live Sessions' && navigation?.navigate?.(navRouteForTab(t))} />
