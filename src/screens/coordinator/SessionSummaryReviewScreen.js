// screens/coordinator/SessionSummaryReviewScreen.js
...
export default function SessionSummaryReviewScreen({ navigation }) {
  ...
  const handleRequestChanges = async (id, reason, notes) => {
    try {
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <CoordinatorNav activeTab="Review" onTabPress={(t) => t !== 'Review' && navigation?.navigate?.(navRouteForTab(t))} />
