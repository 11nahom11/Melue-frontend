// screens/coordinator/CoordinatorStudentProgressScreen.js
...
export default function CoordinatorStudentProgressScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <CoordinatorNav activeTab="Progress" onTabPress={(t) => t !== 'Progress' && navigation?.navigate?.(navRouteForTab(t))} />
