// screens/coordinator/components/CoordinatorNav.js
// Coordinator-specific nav bar. TopNav (Teacher role) has a different tab
// set (Session/Daily Notes/etc) that doesn't apply here, so this role
// gets its own nav component following the same visual pattern.
...
const TABS = ['Dashboard', 'Live Sessions', 'Review', 'Progress', 'Schedule', 'Parents'];

export default function CoordinatorNav({ activeTab, onTabPress }) {
