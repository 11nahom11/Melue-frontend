// screens/coordinator/components/ReassignStudentsModal.tsx
// SCR-TC-005 (Operational Management): capacity-validated reassignment of
// students between teachers for the selected day. Wires to
// reassignStudents() from the session API. Capacity model matches the app:
// each appointment holds up to 2 students.
