// screens/coordinator/StudentEnrollmentScreen.tsx
// MR-16/18: Student Register — list with search & filtering, entry point
// to the Enrollment Wizard (MR-19) and the Student Profile.
